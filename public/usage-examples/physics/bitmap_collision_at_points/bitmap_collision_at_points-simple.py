...
# Check for collisions using Point2D directly
if bitmap_collision_at_points(sk_bmp, sk_bmp_loc, file_bmp, file_bmp_loc):
    write_line("SplashKit got a new file!")

if bitmap_collision_at_points(sk_bmp, sk_bmp_loc, bug_bmp, bug_bmp_loc):
