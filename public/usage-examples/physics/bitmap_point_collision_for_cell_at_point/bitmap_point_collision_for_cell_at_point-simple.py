...
if bitmap_point_collision_for_cell_at_point(sk_bmp, 20, sk_bmp_loc, black_dot_loc):
    write_line("Black Dot Collision")
if bitmap_point_collision_for_cell_at_point(sk_bmp, 200, sk_bmp_loc, red_dot_loc):
