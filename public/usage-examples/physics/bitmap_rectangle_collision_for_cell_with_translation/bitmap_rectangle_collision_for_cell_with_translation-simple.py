...
if bitmap_rectangle_collision_for_cell_with_translation(sk_bmp, 50, bmp_matrix, black_rectangle):
    write_line("Black Rectangle Collision!")
if bitmap_rectangle_collision_for_cell_with_translation(sk_bmp, 50, bmp_matrix, red_rectangle):
