...
int main()
{
    ...
    matrix_2d bmp_matrix = translation_matrix(bmp_loc);
    ...
    if (bitmap_rectangle_collision(sk_bmp, 50, bmp_matrix, black_rectangle))
        write_line("Black Rectangle Collision!");

    if (bitmap_rectangle_collision(sk_bmp, 50, bmp_matrix, red_rectangle))
