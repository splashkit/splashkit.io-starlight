...
file_bmp_matrix = translation_matrix_to_point(file_bmp_loc)
bug_bmp_matrix = translation_matrix_to_point(bug_bmp_loc)
...
# Check for collisions using matrices
if bitmap_collision_for_cells_with_translations(sk_bmp, 50, sk_bmp_matrix, file_bmp, 20, file_bmp_matrix):
    write_line("SplashKit got a new file!")

if bitmap_collision_for_cells_with_translations(sk_bmp, 50, sk_bmp_matrix, bug_bmp, 200, bug_bmp_matrix):
