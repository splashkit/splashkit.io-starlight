...
if bitmap_collision(sk_bmp, sk_bmp_loc.x, sk_bmp_loc.y, file_bmp, file_bmp_loc.x, file_bmp_loc.y):
    write_line("SplashKit got a new file!")

if bitmap_collision(sk_bmp, sk_bmp_loc.x, sk_bmp_loc.y, bug_bmp, bug_bmp_loc.x, bug_bmp_loc.y):
