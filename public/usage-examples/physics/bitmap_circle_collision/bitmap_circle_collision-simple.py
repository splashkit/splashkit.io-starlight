...
draw_bitmap(sk_bmp, bmp_loc_x, bmp_loc_y)
draw_circle_record(color_black(), black_circle)
draw_circle_record(color_red(), red_circle)

# Check for collisions
if bitmap_circle_collision(sk_bmp, bmp_loc_x, bmp_loc_y, black_circle):
    write_line("Black Circle Collision!")
if bitmap_circle_collision(sk_bmp, bmp_loc_x, bmp_loc_y, red_circle):
