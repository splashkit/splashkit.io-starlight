...
**Description:** This guide helps resolve the error `zsh: command not found: skm` on MacOS. This issue occurs when the SplashKit path is not correctly set in the `.zshrc` file.
