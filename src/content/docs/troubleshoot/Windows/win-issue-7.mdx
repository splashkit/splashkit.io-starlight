...
**Description:** This guide provides instructions to update the system “Path” variable on Windows to include the paths required by SplashKit, resolving related issues.
