...
For more info, you can look at the completed **Write Line** examples: [Link to README in "write_line" folder](/src/assets/usage-examples-code/terminal/write_line/README.md)
