...
int main()
{
    ...
    int some_number = to_integer(some_string);
...
//Convert the string "2017" to an integer 2017
string some_string = "2017";
int some_number = ToInteger(some_string);
...
namespace UsefulUtilities
{
    public class Program
    {
        public static void Main()
        {
            //Convert the string "2017" to an integer 2017
            string some_string = "2017";
            int some_number = SplashKit.ToInteger(some_string);
            ...
            //Convert the string "3.14159265358979" to a double ~3.141593
            string pi_string = "3.14159265358979";
            double pi = SplashKit.ToDouble(pi_string);
...
## Convert the string "2017" to an integer 2017
some_string = "2017"
some_number = to_integer(some_string)
...
Consider you want to write a program that accepts two numbers as input from a user, multiplies them, and outputs the result. One way to accomplish this is to use SplashKit's [To Integer](/api/utilities/#convert-to-integer) function.
...
int main()
{
    ...
    inum_1 = to_integer(snum_1);
    inum_2 = to_integer(snum_2);
...
The same can be achieved for decimal numbers, simply by swapping `to_integer` with `to_double`, and using the appropriate data types.
...
inum_1 = to_double(snum_1);
inum_2 = to_double(snum_2);
...
//Convert user input to integers
inum_1 = ToInteger(snum_1);
inum_2 = ToInteger(snum_2);
...
The same can be achieved for decimal numbers, simply by swapping `ToInteger`with `ToDouble`, and using the appropriate data types.
...
inum_1 = ToDouble(snum_1);
inum_2 = ToDouble(snum_2);
...
namespace UsefulUtilities
{
    public class Program
    {
        public static void Main()
        {
            ...
            //Convert user input to integers
            inum_1 = SplashKit.ToInteger(snum_1);
            inum_2 = SplashKit.ToInteger(snum_2);
...
The same can be achieved for decimal numbers, simply by swapping `SplashKit.ToInteger`with `SplashKit.ToDouble`, and using the appropriate data types.
...
inum_1 = SplashKit.ToDouble(snum_1);
inum_2 = SplashKit.ToDouble(snum_2);
...
namespace UsefulUtilities
{
    public class Program
    {
        public static int ReadInteger(string prompt)
        {
            ...
            // Convert the user input to an integer before returning it.
            return SplashKit.ToInteger(line);
        }
