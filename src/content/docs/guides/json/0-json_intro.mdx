...
<Tabs syncKey="code-language">
  ...
  string gameTitle = gameData.GetString("gameTitle");

  SplashKit.Write("Game Title: ");
  SplashKit.WriteLine(gameTitle);
...
<Tabs syncKey="code-language">
  ...
  Json gameData = JsonFromFile("Resources/json/game_data.json");
