...
The following code illustrates the use of the concepts covered so far. You can now make multiple requests in your browser, and you can navigate to [http://localhost:8080/quit] to get the web server to stop.
