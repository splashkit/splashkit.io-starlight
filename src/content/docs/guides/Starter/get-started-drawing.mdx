...
* [Clear Screen](/components/graphics#clear_screen)
* [Draw Circle](/components/graphics#draw_circle)
* [Fill Circle](/components/graphics#fill_circle)
* [Draw Rectangle](/components/graphics#draw_rectangle)
* [Fill Rectangle](/components/graphics#fill_rectangle)
* [Draw Triangle](/components/graphics#draw_triangle)
* [Fill Triangle](/components/graphics#fill_triangle)
* [Draw Ellipse](/components/graphics#draw_ellipse)
* [Fill Ellipse](/components/graphics#fill_ellipse)
* [Draw Line](/components/graphics#draw_line)
